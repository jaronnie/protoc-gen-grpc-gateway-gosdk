module.exports = {
  ...
  locales: {
    ...
    '/': {
      ...
      title: 'protoc-gen-go-httpsdk',
      description: 'protoc-gen-go-httpsdk docs'
    },
  },
  plugins: [
  ...
  themeConfig: {
    docsRepo: 'https://github.com/jaronnie/protoc-gen-go-httpsdk',
    docsBranch: 'main',
    docsDir: 'docs',
      ...
      '/': {
        ...
        sidebar: {
          '/guide/': [
          {
            ...
            collapsable: false,
            children: [
              { title: '1.1 什么是 protoc-gen-go-httpsdk?', path: '/guide/introduction/what-is-protoc-gen-go-httpsdk' },
